...
.elaina-page .hero {
  ...
  background: linear-gradient(135deg, #0a0a1a 0%, #1a1a1e 25%, #222226 50%, #1e1e22 75%, #0a0a1a 100%);
}
.elaina-page .hero-glow { position: absolute; border-radius: 50%; filter: blur(80px); pointer-events: none; opacity: 0.15; }
.elaina-page .hero-glow-1 { width: 360px; height: 360px; background: #8c949e; top: -80px; left: -80px; animation: float 8s ease-in-out infinite; }
.elaina-page .hero-glow-2 { width: 260px; height: 260px; background: #b8bec6; bottom: -60px; right: -50px; animation: float 10s ease-in-out infinite reverse; }
...
.elaina-page .hero-badge { display: inline-flex; align-items: center; gap: 6px; background: rgba(140,148,158,0.15); border: 1px solid rgba(140,148,158,0.3); padding: 5px 14px; border-radius: 50px; font-size: 12px; color: #dde0e4; font-weight: 500; width: fit-content; margin-bottom: 6px; }
.elaina-page .hero-badge .dot { width: 7px; height: 7px; background: #8c949e; border-radius: 50%; animation: pulseGlow 2s ease-in-out infinite; }
.elaina-page .hero-name-jp { font-size: clamp(36px, 6vw, 56px); font-weight: 900; line-height: 1.1; background: linear-gradient(135deg, #edf0f3 0%, #8c949e 40%, #b8bec6 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; letter-spacing: 0.05em; }
.elaina-page .hero-name-sub { font-size: 16px; color: #94a3b8; font-weight: 400; letter-spacing: 0.06em; }
.elaina-page .hero-title-badge { display: inline-flex; align-items: center; gap: 6px; background: rgba(140,148,158,0.1); border: 1px solid rgba(140,148,158,0.25); padding: 6px 16px; border-radius: 8px; font-size: 16px; color: #b8bec6; font-weight: 600; width: fit-content; margin-top: 4px; }
...
.elaina-page .hero-avatar-ring { position: absolute; inset: -14px; border-radius: 50%; border: 3px solid transparent; background: linear-gradient(135deg, #8c949e, #b8bec6, #9ea5ad, #8c949e) border-box; -webkit-mask: linear-gradient(#fff 0 0) padding-box, linear-gradient(#fff 0 0); -webkit-mask-composite: xor; mask-composite: exclude; animation: spinSlow 8s linear infinite; }
.elaina-page .hero-avatar { width: 100%; height: 100%; border-radius: 50%; box-shadow: 0 0 50px rgba(140,148,158,0.3); }
...
.elaina-page .main-tab-btn.active { color: #8c949e; }
.elaina-page .main-tab-btn.active::after { content: ''; position: absolute; bottom: 0; left: 16px; right: 16px; height: 3px; background: linear-gradient(135deg, #8c949e, #b8bec6); border-radius: 2px 2px 0 0; }
...
.elaina-page .info-card-icon.purple { background: #f5f6f8; } .elaina-page .info-card-icon.pink { background: #fce7f3; } .elaina-page .info-card-icon.cyan { background: #ecfeff; }
...
.elaina-page .key-tag { display: inline-flex; align-items: center; gap: 4px; padding: 5px 12px; border-radius: 7px; font-size: 12px; font-weight: 600; background: #f5f6f8; color: #9ea5ad; }
...
.elaina-page .ability-icon { width: 56px; height: 56px; border-radius: 14px; display: flex; align-items: center; justify-content: center; font-size: 28px; flex-shrink: 0; background: linear-gradient(135deg, #f5f6f8, #edf0f3); }
...
.elaina-page .blockquote { margin-top: 24px; padding: 20px 24px; background: linear-gradient(135deg, #f5f6f8, #f9fafb); border-left: 4px solid #8c949e; border-radius: 0 12px 12px 0; font-size: 17px; color: #b0b5bc; font-weight: 500; line-height: 1.8; }
